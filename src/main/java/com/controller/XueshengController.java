...
public class XueshengController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XueshengEntity user = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody XueshengEntity xuesheng){
    	...
    	XueshengEntity user = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("zhanghao", xuesheng.getZhanghao()));
		if(user!=null) {
