<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="校企联系人" prop="xiaoqilianxiren">
          <el-input v-model="ruleForm.xiaoqilianxiren" 
              placeholder="校企联系人" clearable  :readonly="ro.xiaoqilianxiren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="校企联系人" prop="xiaoqilianxiren">
              <el-input v-model="ruleForm.xiaoqilianxiren" 
                placeholder="校企联系人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiyemingcheng = true;
          ...
          if(o=='xiaoqilianxiren'){
            this.ruleForm.xiaoqilianxiren = obj[o];
	    this.ro.xiaoqilianxiren = true;
            continue;
          }
          if(o=='shoujihaoma'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qiyedanwei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiyedanweiCrossAddOrUpdateFlag = false;
                  this.parent.search();
